...
```json
{
  ...
  "principal": {
    "type": "user",
    "user_id": "u_treasury_jsmith",
    "user_email": "j.smith@treasury.gov",
    "idp_session_id": "saml_sess_abc123",
    "api_key_id": null,
    "service_account_name": null
  },
  "organization_id": "org_treasury_ofac",
  "source_ip": "10.14.2.55",
  "legal_basis": "sanctions_screening",
...
curl "https://your-hostname/v1/audit?user_id=u_treasury_jsmith" \
  -H "X-API-Key: your_api_key"

# Queries with a specific legal basis
curl "https://your-hostname/v1/audit?legal_basis=sanctions_screening" \
  -H "X-API-Key: your_api_key"
```
